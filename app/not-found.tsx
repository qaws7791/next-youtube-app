...
export default function NotFound() {
  return (
    <div className="max-w-screen-xl bg-neutral-950 mx-auto rounded-3xl sm:rounded-6xl transition-all p-4 md:p-8 flex flex-col items-center h-[calc(100vh-2rem)] p-4">
